const AP_BURST = [3089, 3135, 4645, 6655, 3157, 3102, 4628, 3118, 2503, 4646];
const AP_ASSASSIN = [3152, 3100, 4645, 3089, 3157, 4646, 3135, 2503, 4633];
const AP_BATTLEMAGE = [4633, 6653, 3116, 3089, 3157, 3165, 4629, 3102, 3135];
const AD_ASSASSIN = [3142, 6697, 6698, 3179, 3814, 6694, 6696, 6699, 6676];
const ADC_CRIT = [3031, 3036, 3046, 3094, 3097, 6672, 3072, 6673, 3033, 3085];
const AD_BRUISER = [3071, 6333, 3053, 3161, 6610, 3748, 6631, 3074, 3078, 3181];
const TANK = [3068, 3143, 3083, 3084, 3065, 3110, 6665, 323075, 3742, 2502, 6664];
const ON_HIT = [3115, 3124, 3153, 3091, 3302, 6672, 3089];
